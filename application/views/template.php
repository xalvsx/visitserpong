...
<head>
	...
	<link href="<?php echo base_url(); ?>assets/css/components-md.css" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo base_url(); ?>assets/js/scripts/metronic.js" type="text/javascript"></script>
<!--
<script src="<?php echo base_url(); ?>assets/js/scripts/layout.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/js/scripts/demo.js" type="text/javascript"></script>
-->
<script>
